...
public abstract class BasePageChooser extends BaseChooser {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.alivc_race_recorder_dialog_chooser_base, container);
        return view;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mLlBlank = view.findViewById(R.id.ll_blank);


        mTabPageIndicator.setTextColorResource(R.color.aliyun_svideo_tab_text_color_selector);
        mTabPageIndicator.setTabViewId(R.layout.aliyun_race_svideo_layout_tab_top);
    ...
    public void onStart() {
        ...
        mLlBlank.setOnClickListener(new View.OnClickListener() {
            @Override
