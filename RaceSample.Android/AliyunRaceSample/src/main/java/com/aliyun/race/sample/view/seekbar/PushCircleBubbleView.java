...
class PushCircleBubbleView extends View {
    ...
    PushCircleBubbleView(Context context) {
        this(context, null);
    }

    PushCircleBubbleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    PushCircleBubbleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init("100");
    }

    PushCircleBubbleView(BuilderParams p, String maxLengthText) {
