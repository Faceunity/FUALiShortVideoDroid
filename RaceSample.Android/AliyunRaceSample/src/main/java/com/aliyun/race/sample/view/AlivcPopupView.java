...
public class AlivcPopupView {
    ...
    protected int makeWidthMeasureSpec() {
        return View.MeasureSpec.makeMeasureSpec(getWidth(mContext), View.MeasureSpec.AT_MOST);
    }

    protected int makeHeightMeasureSpec() {
        return View.MeasureSpec.makeMeasureSpec(getHeight(mContext), View.MeasureSpec.AT_MOST);
    }
    ...
    public void setContentView(View root) {
        ...
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                AlivcPopupView.this.mPopupWindow.dismiss();
            }
        });
    }
    ...
    protected int getRootLayout() {
        return R.layout.alivc_race_popup_layout;
    }
