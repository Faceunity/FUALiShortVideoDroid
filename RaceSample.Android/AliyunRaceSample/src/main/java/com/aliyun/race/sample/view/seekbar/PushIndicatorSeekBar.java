...
public class PushIndicatorSeekBar extends View implements ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    private PushIndicator mIndicator;
    ...
    public PushIndicatorSeekBar(Context context) {
        this(context, null);
    }

    public PushIndicatorSeekBar(Builder builder) {
    ...
    public PushIndicatorSeekBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PushIndicatorSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setIndicatorGap(int gap) {
        if (mBuildParams.mShowIndicator && mIndicator == null) {
            mIndicator = new PushIndicator(mContext, this, mBuildParams);
     ...
     */
    public PushIndicator getIndicator() {
        return mIndicator;
    }
    ...
    public interface OnSeekBarChangeListener {
         ...
         */
        void onProgressChanged(PushIndicatorSeekBar seekBar, int progress, float progressFloat, boolean fromUserTouch);
         ...
         */
        void onSectionChanged(PushIndicatorSeekBar seekBar, int thumbPosOnTick, String textBelowTick, boolean fromUserTouch);
         ...
         *                       no ticks on seek bar, so the thumbPosition will be always -1.
         */
        void onStartTrackingTouch(PushIndicatorSeekBar seekBar, int thumbPosOnTick);
         ...
         * @param seekBar The SeekBar in which the touch gesture began
         */
        void onStopTrackingTouch(PushIndicatorSeekBar seekBar);
    }

    public static class Builder {
        BuilderParams p;
        PushIndicatorSeekBar indicatorSeekBar;
         ...
         */
        public PushIndicatorSeekBar build() {
            return new PushIndicatorSeekBar(this);
        }
         ...
         * @return
         */
        public PushIndicatorSeekBar apply() {
        ...
        Builder setSeekBar(PushIndicatorSeekBar indicatorSeekBar) {
