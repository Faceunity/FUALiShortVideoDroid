...
public class CircleProgressBar extends View {
    ...
    public CircleProgressBar(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
        ...
        TypedArray array = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.MusicCircleProgressBar);
        mBackgroundWidth = array.getDimension(R.styleable.MusicCircleProgressBar_musicBackgroundWidth, mBackgroundWidth);
        mBackgroundHeight = array.getDimension(R.styleable.MusicCircleProgressBar_musicBackgroundHeight, mBackgroundHeight);
        mProgressWidth = array.getDimension(R.styleable.MusicCircleProgressBar_musicProgressWidth, mProgressWidth);
        mProgressThickness = array.getDimension(R.styleable.MusicCircleProgressBar_musicProgressThickness, mProgressThickness);
        mBackgroundColor = array.getColor(R.styleable.MusicCircleProgressBar_musicBackgroundColor, mBackgroundColor);
        mProgressColor = array.getColor(R.styleable.MusicCircleProgressBar_musicProgressColor, mProgressColor);
        progressThicknessColor = array.getColor(R.styleable.MusicCircleProgressBar_musicProgressThicknessColor, progressThicknessColor);
        array.recycle();
        instantiate();
    }
