...
public class FaceBeautySkinControlView extends BaseControlView {
    ...
    public FaceBeautySkinControlView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public FaceBeautySkinControlView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAdapter() {
        mBeautyAdapter = new BaseListAdapter<>(new ArrayList<>(), new BaseDelegate<FaceBeautyBean>() {
            ...
            public void convert(int viewType, BaseViewHolder helper, FaceBeautyBean data, int position) {
                ...
                helper.itemView.setSelected(mSkinIndex == position);
