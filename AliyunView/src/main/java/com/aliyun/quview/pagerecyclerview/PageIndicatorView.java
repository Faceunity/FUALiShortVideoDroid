...
public class PageIndicatorView extends LinearLayout {
    ...
    public PageIndicatorView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            margins = ta.getDimensionPixelSize(R.styleable.PageIndicatorView_pi_Margin, DimensionConvert.dip2px(context, 5));
            dotSize = ta.getDimensionPixelSize(R.styleable.PageIndicatorView_pi_DotSize, DimensionConvert.dip2px(context, 6));
        }finally {
            ta.recycle();
        }
    }
    ...
    public PageIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mNormalResID = ta.getResourceId(R.styleable.PageIndicatorView_pi_NormalBackground, android.R.drawable.presence_invisible);
            margins = ta.getDimensionPixelSize(R.styleable.PageIndicatorView_pi_Margin, DimensionConvert.dip2px(context, 5));
            dotSize = ta.getDimensionPixelSize(R.styleable.PageIndicatorView_pi_DotSize, DimensionConvert.dip2px(context, 4));
        }finally {
            ta.recycle();
        }
        init(context);
