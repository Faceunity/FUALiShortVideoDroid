...
public class PaintChooserView extends BaseChooser implements View.OnClickListener {
    ...
    protected void init() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.alivc_editor_view_chooser_paint, this, true);
        //初始化titile界面
        ...
        mTvEffectTitle.setText(R.string.alivc_editor_effect_paint);
    ...
    private void clearPaint() {
        mPaintOne.setBackgroundResource(R.color.alivc_common_bg_transparent);
        mPaintTwo.setBackgroundResource(R.color.alivc_common_bg_transparent);
        mPaintThree.setBackgroundResource(R.color.alivc_common_bg_transparent);
    }
