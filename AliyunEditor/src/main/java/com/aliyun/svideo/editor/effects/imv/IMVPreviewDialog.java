...
public class IMVPreviewDialog extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.alivc_editor_dialog_imv_preview, container);
    ...
    private void initView() {
        ...
        new ImageLoaderImpl().loadImage(mContext, getArguments().getString(KEY_THUMB_URL, "")).into(thumbView);
        startPlayVideo();
    }
