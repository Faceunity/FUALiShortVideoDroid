...
public class RollCaptionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public RollCaptionAdapter(Context context) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (SYSTEM_FONT.equals(iconPath)) {
            ...
            if(iconPath.startsWith("R")){
                if(iconPath.contains("pty")){
                    captionViewHolder.mImage.setImageResource(R.mipmap.aliyun_svideo_pty_font_icon);
                }else{
                    captionViewHolder.mImage.setImageResource(R.mipmap.aliyun_svideo_xk_font_icon);
                }
    ...
    private void getFontFromLocal() {
        ...
        try {
            String[] fonts = mContext.getAssets().list("font");
            for (String font : fonts) {
                FontForm ff = new FontForm();
                if("Pangtouyu.ttf".equals(font)){
                    ff.setIcon("R.mipmap.aliyun_svideo_pty_font_icon");
                }else{
                    ff.setIcon("R.mipmap.aliyun_svideo_xk_font_icon");
                }

                ff.setUrl(EditorCommon.SD_DIR + "font" + File.separator + font);
                fontData.add(fontData.size(), ff);
