...
public class TransitionAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position, List<Object> payloads) {
        ...
        for (Object payload : payloads) {
            if (TransitionChooserView.TRANSITION_PAYLOAD.equals(payload)) {
                mOnSelectListener.onSelect(transitionViewHolder.mTransition, position, false);
            }
        }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (mOnSelectListener != null) {
            mOnSelectListener.onSelect(transitionViewHolder.mTransition, position,
                                       mSelectPosition == -1);
    ...
    public interface OnSelectListener {
        void onSelect(ImageView iv, int position, boolean isClickTransition);
    }
}
