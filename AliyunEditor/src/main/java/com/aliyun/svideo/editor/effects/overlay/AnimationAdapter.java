...
public class AnimationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private AnimationDialog.OnItemClickListener mOnItemClickListerner;
    ...
    public void setOnItemClickListener(AnimationDialog.OnItemClickListener listener) {
        mOnItemClickListerner = listener;
    }

    @Override
    public int getItemCount() {
        return AnimationDialog.POSITION_FONT_ANIM_ARRAY.length;
    }
