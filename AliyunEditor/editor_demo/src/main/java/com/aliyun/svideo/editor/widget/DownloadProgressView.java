...
public class DownloadProgressView extends FrameLayout {
    ...
    private void initView() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.alivc_svideo_layout_download_progress, this,
            true);
    ...
    public void setDownloadState(int state) {
        switch (state) {
            case VIEW_TYPE_REMOTE:
                // 未下载
                tvDownloadState.setText(getResources().getString(R.string.download_effect_edit));
            ...
            case VIEW_TYPE_DOWNLOADING:
                // 下载中
                tvDownloadState.setText(getResources().getString(R.string.downloading_effect_edit));
                downloadFinish.setVisibility(INVISIBLE);
                break;
