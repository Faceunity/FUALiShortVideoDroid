...
public class AnimojiView extends Fragment implements IPageTab, OnClearEffectListener, DistortingMirrorAdapter.OnItemListener {
    private static final String TAG = AnimojiView.class.getSimpleName();
    //RecyclerView列数
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new DistortingMirrorAdapter(getActivity(), Effect.EFFECT_TYPE_ANIMOJI);
