...
public class ThreeDStickerView extends Fragment implements IPageTab, OnClearEffectListener, DistortingMirrorAdapter.OnItemListener {
    private static final String TAG = ThreeDStickerView.class.getSimpleName();
    //RecyclerView列数
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new DistortingMirrorAdapter(getActivity(), Effect.EFFECT_TYPE_NORMAL);
