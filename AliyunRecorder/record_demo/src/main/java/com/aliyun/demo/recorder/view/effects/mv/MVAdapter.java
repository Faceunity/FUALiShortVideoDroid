...
public class MVAdapter extends RecyclerView.Adapter<MVAdapter.MVViewHolder> implements View.OnClickListener{
    ...
    private List<EffectBody<IMVForm>> mDataList;
    ...
    public MVAdapter(Context mContext) {
        ...
        form.setId(-1);
        EffectBody<IMVForm> effectBody= new EffectBody<IMVForm>(form,true);
     ...
     * @param position
     */
    public synchronized void notifyDownloadingComplete(EffectBody<IMVForm> mvBody, int position,boolean isError) {
    ...
    public void updateProcess(MVViewHolder viewHolder, int process, int position) {
    ...
    public List<EffectBody<IMVForm>> getDataList() {
        return mDataList;
    }
}
