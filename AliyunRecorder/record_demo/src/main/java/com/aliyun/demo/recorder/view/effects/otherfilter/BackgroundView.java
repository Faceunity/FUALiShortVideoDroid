...
public class BackgroundView extends Fragment implements IPageTab, OnClearEffectListener, DistortingMirrorAdapter.OnItemListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new DistortingMirrorAdapter(getActivity(), Effect.EFFECT_TYPE_BACKGROUND);
